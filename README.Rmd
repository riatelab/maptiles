...
```{r example,fig.ext="png", margin = TRUE, fig.width=852/96, fig.height = 269/96, dpi = 96, fig.show='hide'}
library(sf)
library(maptiles)
...
```{r example2,fig.ext="png", margin = TRUE, fig.width=852/96, fig.height = 269/96, fig.show='hide', dpi = 96}
# define the query
fullserver <- paste(
